...
pipe_t2 = pygame.image.load('images/pipes1_v10.png')
pipe_t2 = pygame.transform.scale(pipe_t2, (100, 100))
pipe_t1 = pygame.transform.rotate(pipe_t2, 90)
pipe_t6 = pygame.image.load('images/pipes2_v5.png')
...
big_pipe_t3 = pygame.image.load('images/pipes2_v5.png')
big_pipe_t3 = pygame.transform.scale(big_pipe_t3, (300, 300))
big_pipe_t3 = pygame.transform.rotate(big_pipe_t3, 270)

plumber = pygame.image.load('images/plumber_pic1.png')
plumber = pygame.transform.scale(plumber, (500, 300))
plumber1 = pygame.image.load('images/plumber_pic2.png')
plumber1 = pygame.transform.scale(plumber1, (650, 400))
plumber2 = pygame.image.load('images/plumber_pic3.png')
